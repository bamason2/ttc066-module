...
<img src="figures/spectral_densities.png" width=400>
...
In order to perform some quick hand calculations on the expected frequencies and damping ratios that given parameter choices will provide, we can also think of the quarter car model in terms of modal simplications. To consider body-bounce, or wheel-hop alone;
...
in $\textbf{rad/s}$. Expected in the range 11 – 13 Hz, what is the wheel-hop frequency here?
